...
function playSound(e){
    ...
    audio.currentTime = 0; // start again 
    audio.play(); // audio pal function
}


const keys = Array.from(document.querySelectorAll('.key')); //create key veriable to array key class to make each function 
